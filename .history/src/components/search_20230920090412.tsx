    ...
    return (
        <div className="mb-6">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-300 mb-4 mt-2" data-aos="zoom-y-out" data-aos-delay="150">The go-to platform for housing in Korea for students, workers, long-term stayers. Through various housing options find your next aparment</p>
