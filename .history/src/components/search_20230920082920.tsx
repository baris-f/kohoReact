...
const Search: React.FC<Props> = ({children}) => {
    return (
        <div className="mb-6">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Find your <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400">Korean Home</span></h1>
            <b className="text-xl text-gray-900 mb-10"> One-room • Sharehouse • Goshiwon</b>
            <h1 className="text-xl text-gray-900 mb-8"> One-room • Sharehouse • Goshiwon</h1>
