...
const Search: React.FC<Props> = ({children}) => {
    return (
        <div className="mb-6">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Find your <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-sandy-beach-100">Korean Home</span></h1>
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Where anything can be found related to housing in Korea .</p>
