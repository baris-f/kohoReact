...
const Search: React.FC<Props> = ({children}) => {
    return (
        <div className="mb-6">
            ...
            <b className="text-xl text-gray-900 mb-9"> One-room • Sharehouse • Goshiwon</b>
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8 mt-8" data-aos="zoom-y-out" data-aos-delay="150">The go-to platform for housing in Korea</p>
            ...
            <div className="mt-3 sm:mt-6 mx-auto max-w-xl relative">
                <form>
                    <div
                        ...
                        <div className="pb-0 sm:pb-0 sm:flex-[1_0_0%]">
                            {/*
