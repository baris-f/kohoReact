...
const Search: React.FC<Props> = ({children}) => {
    return (
        <div className="mb-6">
            ...
            <h3 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Find your <span className="bg-clip-text text-transparent bg-gradient-to-r text-black">One-room • Sharehouse • Goshiwon </span></h3>
