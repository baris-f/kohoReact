...
const Search: React.FC<Props> = ({children}) => {
    return (
        <div className="mb-6">
            ...
            <p className="text-xl text-gray-900 mb-9"> One-room • Sharehouse • Goshiwon</p>
            <div className="max-w-3xl mx-auto">
              <b className="text-xl text-gray-600 mb-4 mt-2" data-aos="zoom-y-out" data-aos-delay="150">The go-to platform for housing in Korea for students, workers, long-term stayers.</b>
